...
levels: fresher, mid, and experienced. Each summary should be limited to 3 to 4 lines !important,
				...
				<form onSubmit={handleSubmit}>
					...
					{aiGeneratedSummary && (
						<div>
                            ...
                            border-primary/30
                          "
										onClick={() => handleSelect(summary.summary)}
									>
										...
										<CardContent className="text-sm">
											{summary.summary.map((summary: string, idx: number) => (
												<p key={idx}>{summary}</p>
											))}
										</CardContent>
									</Card>
